...
function Input2({
  ...
  const statusAdornment = (() => {
    if (state === "loading" || state === "validating") return /* @__PURE__ */ jsxRuntime.jsx(Spinner, { size: spec.icon - 2 });
    if (state === "readonly")
          ...
          radixUi.Checkbox.Root,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              radixUi.Checkbox.Indicator,
              {
                ...
                children: indeterminate ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Minus, { className: cn(ICON_SIZE[size], "stroke-[3]") }) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { className: cn(ICON_SIZE[size], "stroke-[3]") })
              }
            )
          }
        ),
