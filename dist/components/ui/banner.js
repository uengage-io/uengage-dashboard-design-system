...
var BannerIcon = React.forwardRef(
...
var BannerContent = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "div",
  {
    ref,
...
var BannerTitle = React.forwardRef(({ className, style, ...props }, ref) => /* @__PURE__ */ jsx(
  "span",
  {
    ref,
...
var BannerDescription = React.forwardRef(({ className, style, ...props }, ref) => /* @__PURE__ */ jsx(
  "span",
  {
    ref,
    className: cn("min-w-0", className),
...
var BannerAction = React.forwardRef(({ className, type = "button", ...props }, ref) => /* @__PURE__ */ jsx(
  "button",
  {
    ref,
    type,
...
var BannerClose = React.forwardRef(({ className, type = "button", "aria-label": ariaLabel = "Dismiss", ...props }, ref) => /* @__PURE__ */ jsx(
  "button",
  {
    ref,
    type,
...
export { BANNER_BAR_PALETTE, BANNER_SIZES, BANNER_TONE_DOT, BANNER_TONE_SEVERITY, BannerAction, BannerClose, BannerContent, BannerDescription, BannerIcon, BannerRoot, BannerTitle, bannerVariants, getBannerPalette, toBannerToneKey };
