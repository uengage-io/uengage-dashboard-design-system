...
declare function PopoverContent({ className, align, sideOffset, style, children, ...props }: React.ComponentProps<typeof Popover$1.Content>): react_jsx_runtime.JSX.Element;
