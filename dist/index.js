  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5 min-w-0", width, className), children: [
    ...
    /* @__PURE__ */ jsxs("div", { ref: wrapperRef, className: "relative", children: [
      /* @__PURE__ */ jsxs("div", { className: cn(inputWrapperVariants({ size, state })), children: [
        ...
        hasRightIcon && /* @__PURE__ */ jsx("span", { className: cn(inputIconSlotVariants({ size, side: "right" })), children: /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1", children: [
          showClear && /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
...
var SectionContext = React19.createContext({
  collapsible: false
});
function SectionHeader({
  ...
  const { collapsible } = React19.useContext(SectionContext);
  ...
  if (dividers) {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        style,
        ...props,
        children: items.map((child, i) => /* @__PURE__ */ jsxs(React19.Fragment, { children: [
...
function Section({
  ...
  if (collapsible) {
    ...
    return /* @__PURE__ */ jsx(SectionContext.Provider, { value: ctx, children: /* @__PURE__ */ jsx(Collapsible.Root, { ...collapsibleProps, asChild: true, children: /* @__PURE__ */ jsx(
      Card,
      {
        "data-slot": "section",
        className: cardClass,
...
function FileUpload({
  ...
  const attachInputRef = React19.useCallback(
    (node) => {
  ...
  const [localFiles, setLocalFiles] = React19.useState([]);
  const [validationErrors, setValidationErrors] = React19.useState([]);
  const isImageVariant = variant === "image" || variant === "avatar";
  const effectiveAccept = accept ?? getDefaultAccept(variant);
  const controlledUrls = React19.useMemo(() => {
    if (!value) return [];
    return Array.isArray(value) ? value.filter(Boolean) : [value].filter(Boolean);
  }, [value]);
  const hasControlledValue = controlledUrls.length > 0;
  const displayItems = React19.useMemo(() => {
    const items = [];
  ...
  const processFiles = React19.useCallback(
    (incoming) => {
  ...
  const openFilePicker = React19.useCallback(() => {
    if (disabled || readOnly) return;
  ...
  const renderImageVariant = () => {
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              icon && /* @__PURE__ */ jsx("div", { className: "absolute bottom-2 right-2 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-white shadow-md border border-gray-100 text-gray-600 pointer-events-none", children: icon }),
              !disabled && !readOnly && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/65 via-black/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 right-0 flex items-center justify-between gap-2 p-2.5 translate-y-1 group-hover:translate-y-0 transition-transform duration-200", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    type: "button",
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
      ...
      displayItems.length === 0 && /* @__PURE__ */ jsxs(
        "div",
        {
          ...dropzoneInteractionProps,
          className: cn(
  ...
  const renderAvatarVariant = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative flex-shrink-0", children: [
        ...
        icon && /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-white shadow border border-gray-100 text-gray-600 pointer-events-none", children: icon })
      ] }),
